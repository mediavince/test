...
$sql = mysqli_query($connection, "SELECT * FROM $tblstring WHERE stringlang='$lg' ORDER BY stringtype,stringtitle ASC ");// AND stringtype='general' ");//(stringtype='general' OR stringtype='jour' OR stringtype='mois')//
if (!$sql) {
  ...
  $sql = mysqli_query($connection, "SELECT * FROM $tblstring WHERE stringlang='$default_lg' ORDER BY stringtype,stringtitle ASC ");
