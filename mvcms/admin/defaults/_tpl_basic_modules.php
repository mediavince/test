...
if ($this_is == 'event') {
    ...
    $filter_search = false;
    $index_by_alpha = true;
    $show_array = array("title", "from");
    $array_tpl = array('<span class="arrow"><a href="', "\$local_url", '&amp;', "\$this_is" ,'Id=', "\$show_id", '" target="_self">', "\$show_from", ' | ', "\$show_title", '</a></span>');

    $show_array_by_id = array("type", "title", "from", "until", "entry", "img", "doc");
    $array_tpl_by_id = array('<div class="centered"><div style="float:right;max-width:', "\$max_width", 'px;">', "\$show_doc", "\$show_img", '</div><h3>', "\$show_type", '</h3><h1>', "\$show_title", '</h1><b>', "\$fromString", ' ', "\$show_from", ' ', "\$untilString", ' ', "\$show_until", '</b><br /><div class="centered">', "\$show_entry", '</div></div>');
    ...
    $array_tpl_linked_by_id = array('<ul class="arrow"><li><a href="', "\$local_url", '" target="_self">', "\$link_title", '</a></li></ul>');
} else {
    // DEFAULT
