...
<head>
  ...
  <meta name="copyright" content="2008, www.mediavince.com" />
	<meta name="description" content="'.$meta_desc.'" />
	<meta name="keywords" content="'.$meta_keyw.'" />
	<title>'.$contTitle.'_'.$this_lg.' :: '.$slogan.'</title>
	<meta http-equiv="content-Type" content="text/html; charset='.$charset_iso.'" />
	<meta name="ROBOTS" content="ALL" />
	<meta name="author" content="www.mediavince.com :: Your content &#064; the front row !" />
...
if	(isset($trace))	
  ...
  $html_index .= '
	<div id="footer">
		...
		<!-- Webdevelopment developed by <a href="http://www.mediavince.com" target="_blank">www.mediavince.com</a> - &copy; 2008 -->';
if	(!stristr($_SERVER['HTTP_HOST'], "localhost"))	$html_index .= '<img src="http://www.mediavince.com/clients/'.$client.'.gif" width="1" height="1" hspace="0" vspace="0" alt="www.mediavince.com :: Your content &#064; the front row !" border="0" />'	;
  $html_index .= '
	</div>
</div>
</body>
