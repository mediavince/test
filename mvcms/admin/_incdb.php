...
if (!isset($mail_charset_iso))
	$mail_charset_iso = "ISO-8859-1"; // this one needs to be before mail headers
...
$mail_headers_basic .= $CRLF.'Content-type: text/html; charset='.$mail_charset_iso;
