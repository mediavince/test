...
function format_edit($text,$do)
{
    ...
    if ($tinyMCE === false) {
        if ($do == "edit") {
            ...
            $text = \str_replace('[email=mailto:][/email]','',$text);
            $text = \str_replace('[email=][/email]','',$text);
            $text = \str_replace('[url=doc://][/url]','',$text);
            $text = \str_replace('[url=https://][/url]','',$text);
            $text = \str_replace('[url=https://][/url]','',$text);
            $text = \str_replace('[url=mailto:][/url]','',$text);
            $text = \str_replace('[url=][/url]','',$text);
            $text = \str_replace('[div=]','',$text);
            $text = \str_replace('[div=][/div]','',$text);
            $text = \str_replace('[img=]','',$text);
            $text = \str_replace('[img=][/img]','',$text);
            $text = \str_replace('[flash=]','',$text);
            $text = \str_replace('[i][/i]','',$text);
